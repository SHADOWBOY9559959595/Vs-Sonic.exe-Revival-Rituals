...
class MainMenuState extends MusicBeatState
{
    ...
    override function create()
    {
		...
		switch (FlxG.random.int(1, 10))
			{
				case 1:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/xeno-1'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 2:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/xeno-2'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 3:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/educator'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 4:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/mono'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 5:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/sanic'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 6:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/sonichu'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 7:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/x-terion'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 8:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/xterion-1'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 9:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/xterion-2'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
				case 10:
					char = new FlxSprite().loadGraphic(Paths.image('MMArts/man'));
					char.scrollFactor.set();
					 char.flipX = true;
					add(char);
			}	
		...
		switch (i) {
			case 0: menuItem.setPosition(130, 200);
			case 1: menuItem.setPosition(110, 300);
			case 2: menuItem.setPosition(90, 400);
			case 3: menuItem.setPosition(70, 500);
