...
class StoryMenuStateMain extends MusicBeatState
{
    public static var weekCompleted:Map<String, Bool> = new Map<String, Bool>();

    var weekNames:Array<String> = [ 'tooslow', 'youcantrun', 'tripletrouble', 'finalescape', 'yourself']; // Add any weeks you want here.
    
    // Songs for each week
    var tooslow:Array<String> = ['too-slow'];
    var youcantrun:Array<String> = ['you-cant-run'];
    var tripletrouble:Array<String> = ['triple-trouble'];
    var finalescape:Array<String> = ['final-escape'];
    var yourself:Array<String> = ['eye-to-eye'];
