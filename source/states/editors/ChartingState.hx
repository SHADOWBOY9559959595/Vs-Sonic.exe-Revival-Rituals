...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['static', "fking screen static\nvalue 1: time on screen (SECONDS)\nvalue 2: Alpha (TRANSPARENCY)\n0 = Fully transparent\n1 = Fully visible\nif null, both values will be set to 0.3"],
		['Flash Camera Red', "value 1:\nspeed of dissapearance"],		
		['RedVG', "value 1:\nspeed of dissapearance"],
		['jumpscare', "fking jumpscare boo\nvalue 1: Name of the image to jumpscare\n(needs to be in shared/images/jumpscares)\nvalue 2: Name of the sound to be played\n(needs to be in shared/sounds/jumpscares)"],
		...
		['Needle Text', ""],
		['Needle static', "Value 1: if empty, adds static\nif set to 1, static will be destroyed"],
		['Needle photos', ""],
	];
